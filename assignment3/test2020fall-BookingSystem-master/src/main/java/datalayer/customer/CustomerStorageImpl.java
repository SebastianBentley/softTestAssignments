        ...
        try (var con = getConnection();
            ...
            try (var resultSet = stmt.executeQuery()) {
                if (resultSet.next()){
                    ...
                    return new Customer(id, firstname, lastname, Optional.ofNullable(phonenumber));
                }
                return null;
            }
        }
        ...
        try (var con = getConnection();
            ...
            try (ResultSet resultSet = stmt.executeQuery("select ID, firstname, lastname, phonenumber from Customers")) {
                ...
                while (resultSet.next()) {
                    ...
                    Customer c = new Customer(id, firstname, lastname, Optional.ofNullable(phonenumber));
                    results.add(c);
                }
            }
